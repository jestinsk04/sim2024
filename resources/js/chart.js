...
(function () {
    ...
    if ($("#report-half-donut-chart").length) {
        let ctx = $("#report-half-donut-chart")[0].getContext("2d");
        let myDoughnutChart = new Chart(ctx, {
            type: "doughnut",
            data: {
                labels: [
    ...
    if ($("#report-half-donut-chart-2").length) {
        let ctx = $("#report-half-donut-chart-2")[0].getContext("2d");
        let myDoughnutChart = new Chart(ctx, {
            type: "doughnut",
            data: {
                labels: [
    ...
    if ($("#pyramid-chart").length) {

        let ctx = $("#pyramid-chart")[0].getContext("2d");
        new Chart(ctx, {
            type: "bar",
            data: {
                ...
                datasets: [
                  {
                    ...
                    data: [100, 95, 90, 85, 80, 75,70,65,60,55,50,45,40,35,30,25,20],
                  },
                  {
                    label: "Mujeres",
                    stack: "Stack 0",
                    backgroundColor: "#2778F0",
                    data: [100, 95, 90, 85, 80, 75,70,65,60,55,50,45,40,35,30,25,20].map((k) => -k),
                  },
                ],
    ...
    if ($("#vertical-bar-chart-widget-2").length) {
        let ctx = $("#vertical-bar-chart-widget-2")[0].getContext("2d");
        let myChart = new Chart(ctx, {
            type: "bar",
            data: {
                labels: [
    ...
    if ($("#vertical-bar-chart-widget-3").length) {
        let ctx = $("#vertical-bar-chart-widget-3")[0].getContext("2d");
        let myChart = new Chart(ctx, {
            type: "bar",
            data: {
                labels: [
