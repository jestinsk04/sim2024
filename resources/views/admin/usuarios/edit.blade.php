...
<div class="alert alert-primary alert-dismissible show flex items-center mb-2" role="alert">
    ...
    <button type="button" class="btn-close text-white" data-tw-dismiss="alert" aria-label="Close">
        <i data-lucide="x" class="w-4 h-4"></i>
                           ...
                           <form method="POST" action="/admin/usuarios-update">
    @csrf
        ...
        <div class="intro-y col-span-12 lg:col-span-12">
            ...
            <div class="intro-y box p-5 grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12">
                    ...
                    <input type="hidden" id="image" name="image" value="{{$data['data']->image}}" required>
                </div>
                <div class="mt-3 col-span-12 xl:col-span-4">
                    <label for="crud-form-1" class="form-label">Nombre</label>
                    <input id="crud-form-1" name="name" type="text" value="{{$data['data']->name}}" class="form-control w-full" placeholder="Nombre"
                        required>
                        <input type="hidden" id="id" name="id" value="{{$data['data']->id}}">
                </div>
                <div class="mt-3 col-span-12 xl:col-span-4">
                    <label for="crud-form-1" class="form-label">Apellido</label>
                    <input id="crud-form-1" name="lname" type="text" value="{{$data['data']->lname}}" class="form-control w-full" placeholder="Apellido"
                        required>

                </div>
                <div class="mt-3 col-span-12 xl:col-span-4">
                    <label for="crud-form-1" class="form-label">Email</label>
                    <input id="crud-form-1" name="email" type="text" value="{{$data['data']->email}}" class="form-control w-full" placeholder="Email"
                        readonly>
                    ...
                    <div class="accordion-item">
                        <div id="faq-accordion-content-admin" class="accordion-header">
                            <button class="accordion-button" type="button" data-tw-toggle="collapse"
                                data-tw-target="#faq-accordion-collapse-admin" aria-expanded="false"
                            ...
                            <div class="accordion-body text-slate-600 dark:text-slate-500 leading-relaxed">
                                <div class="form-check mt-2"
                                    ...
                                    <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                        class="form-check-input" name="accesos[Admin]" @if(isset($data['data']->permisos['Admin'])) checked @endif type="checkbox"
                                        value="admin_general">
                                </div>
                            </div>
                        </div>
                        ...
                        @foreach($data['paises_edit'] as $value)
                        <div class="accordion-item">
                            ...
                            <div id="faq-accordion-collapse-{{ $value->id }}" class="accordion-collapse collapse"
                                aria-labelledby="faq-accordion-content-{{ $value->id }}"
                                ...
                                <div class="accordion-body text-slate-600 dark:text-slate-500 leading-relaxed">
                                    <div class="form-check mt-2"
                                        ...
                                        <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                            class="form-check-input" @if(isset($data['data']['permisos'][$value->name]))
                                        checked @endif name="accesos[{{ $value->name }}]" type="checkbox"
                                        value="{{ $value->name }}">
                                    </div>
                                    ...
                                    <div class="mt-3" style="padding-left:50px;">
                                        ...
                                        <div class="form-check mt-2"
                                            ...
                                            <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                ...
                                                @if(isset($data['data']['permisos'][$value->name]['kpi'])) checked
                                            @endif name="accesos[{{ $value->name }}][kpi]" type="checkbox"
                                            value="kpi">
                                        </div>
                                        ...
                                        <div class="form-check mt-2"
                                            ...
                                            <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                class="form-check-input"
                                                @if(isset($data['data']['permisos'][$value->name]['investigacion']))
                                            checked @endif name="accesos[{{ $value->name }}][investigacion]"
                                            type="checkbox" value="investigacion">
                                        </div>
                                        <div class="mt-3" style="padding-left:100px;">
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <label class="form-check-label" for="checkbox-switch-1">Inestigación Global</label>

                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['investigacion']['global']))
                                                checked @endif
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['investigacion']['adhoc']))
                                                checked @endif
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['investigacion']['online']))
                                                checked @endif
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['investigacion']['hogares']))
                                                checked @endif
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <label class="form-check-label" for="checkbox-switch-1">Investigacion Sindicada</label>

                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['investigacion']['sindicada']))
                                                checked @endif
                                                name="accesos[{{ $value->name }}][investigacion][sindicada]"
                                                type="checkbox" value="sindicada">
                                            </div>
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['investigacion']['otros']))
                                                checked @endif
                                        ...
                                        <div class="form-check mt-2"
                                            ...
                                            <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                class="form-check-input"
                                                @if(isset($data['data']['permisos'][$value->name]['analisis'])) checked
                                            @endif name="accesos[{{ $value->name }}][analisis]" type="checkbox"
                                            value="analisis">
                                        </div>
                                        ...
                                        <div class="mt-3" style="padding-left:100px;">
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['analisis']['global']))
                                                checked @endif
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['analisis']['valoracion_mercado']))
                                                checked @endif
                                                name="accesos[{{ $value->name }}][analisis][valoracion_mercado]"
                                                type="checkbox"
                                                value="valoracion_mercado">
                                            </div>
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['analisis']['rrss']))
                                                checked @endif name="accesos[{{ $value->name }}][analisis][rrss]"
                                                type="checkbox" value="rrss">
                                            </div>
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['analisis']['clientes']))
                                                checked @endif name="accesos[{{ $value->name }}][analisis][clientes]"
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['analisis']['segmentaciones']))
                                                checked @endif
                                                name="accesos[{{ $value->name }}][analisis][segmentaciones]"
                                                type="checkbox"
                                                value="segmentaciones">
                                            </div>
                                             ...
                                             <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['analisis']['continuos']))
                                                checked @endif
                                            ...
                                            <div class="form-check mt-2"
                                                ...
                                                <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                    class="form-check-input"
                                                    @if(isset($data['data']['permisos'][$value->name]['analisis']['otros']))
                                                checked @endif name="accesos[{{ $value->name }}][analisis][otros]"
                                                type="checkbox" value="otros">
                                            </div>
                                        ...
                                        <div class="form-check mt-2"
                                            ...
                                            <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                class="form-check-input"
                                                @if(isset($data['data']['permisos'][$value->name]['tendencias']))
                                            checked @endif name="accesos[{{ $value->name }}][tendencias]"
                                            type="checkbox" value="tendencias">
                                        </div>
                                        ...
                                        <div class="form-check mt-2"
                                            ...
                                            <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                class="form-check-input"
                                                @if(isset($data['data']['permisos'][$value->name]['precios'])) checked
                                            @endif name="accesos[{{ $value->name }}][precios]" type="checkbox"
                                            value="precios">
                                        </div>
                                        ...
                                        <div class="form-check mt-2"
                                            ...
                                            <input id="checkbox-switch-1" style="position: absolute; left: 400px;"
                                                class="form-check-input"
                                                @if(isset($data['data']['permisos'][$value->name]['ventas'])) checked
                                            @endif name="accesos[{{ $value->name }}][ventas]" type="checkbox"
                                            value="ventas">
                                        </div>
