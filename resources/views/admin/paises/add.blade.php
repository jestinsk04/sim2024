...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Añadir País</h2>
</div>
@if(session('update'))
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 lg:col-span-6">
        <form method="POST" action="paises-insert">
            @csrf
            <!-- BEGIN: Form Layout -->
            ...
            <div class="col-span-12">
                    ...
                    <input type="hidden" id="mapa" name="mapa" required>
                </div>
                ...
                <div class="mt-3">
                    ...
                    <input id="crud-form-1" name="moneda" type="text" class="form-control w-full" placeholder="Moneda"
                        required>
                </div>
