...
<div class="alert alert-primary alert-dismissible show flex items-center mb-2" role="alert">
    ...
    <button type="button" class="btn-close text-white" data-tw-dismiss="alert" aria-label="Close">
        <i data-lucide="x" class="w-4 h-4"></i>
                           ...
                           @endif
                           @endif
<h2 class="intro-y text-lg font-medium mt-10">Proveedores</h2>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="proveedores-add" class="btn btn-primary shadow-md mr-2">Añadir nuevo</a>
            <!-- <div class="dropdown">
    ...
    <div id="delete-confirmation-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <form method="post" action="/admin/proveedores-delete">
            @csrf
    ...
    jQuery(function () {
      var table = jQuery('.table-report').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ url('admin/proveedores-list') }}",
          columns: [
              {data: 'name', name: 'name'},
