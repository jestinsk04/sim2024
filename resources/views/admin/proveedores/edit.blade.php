...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Editar Proveedor</h2>
</div>
@if(session('update'))
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 lg:col-span-6">
        <form method="POST" action="/admin/proveedores-update">
            @csrf
            <!-- BEGIN: Form Layout -->
            <div class="intro-y box p-5">
                <div class="mt-3">
                    ...
                    <input id="crud-form-1" name="name" type="text" class="form-control w-full"
                        value="{{ $data['data']->name }}" placeholder="Nombre Proveedor" required>
