    ...
    <select id="filter-year-1" class="form-select form-select-lg sm:mt-2 sm:mr-2 col-span-6 sm:col-span-3 xl:col-span-3"
        ...
        @if(count($data['ventas_2_ano']) > 0)
            ...
            <div class="col-span-12 sm:col-span-4 xl:col-span-3 mt-8 grid grid-cols-1">
                <div class="report-box box p-5 sm:mt-5 grid grid-cols-4">
                    ...
                    <div class="col-span-3">
                        <div class="intro-y block sm:flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5 tooltip" title="Consumo H.P.M">Consumo H.P.M</h2>
                        </div>
                        <div class="intro-y block sm:flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5 ">{{$data['data']['consumo_hpm']}} <small>KG/HAB</small></h2>
                        </div>
                    </div>
                ...
                <div class="report-box box p-5 mt-12 sm:mt-5 grid grid-cols-4">
                    ...
                    <div class="col-span-3">
                        <div class="intro-y block sm:flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5 tooltip" title="Share Volumen">Share Volumen</h2>
                        </div>
                        <div class="intro-y block sm:flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5">{{$data['data']['share_volumen']}}</h2>
                        </div>
                    </div>
                ...
                <div class="report-box box p-5 mt-12 sm:mt-5 grid grid-cols-4">
                    ...
                    <div class="col-span-3">
                        <div class="intro-y block sm:flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5 tooltip" title="Precio Compra MB-EP">Precio Compra MB-EP</h2>
                        </div>
                        <div class="intro-y block sm:flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5">{{$data['data']['precio_compra']}} <small>$/TONELADAS</small></h2>
                        </div>
                    </div>
                ...
                <div class="report-box box p-5 mt-12 sm:mt-5 grid grid-cols-4">
                    ...
                    <div class="col-span-3">
                        <div class="intro-y block sm:flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5 tooltip" title="Share VALOR">Share VALOR</h2>
                        </div>
                        <div class="intro-y block sm:flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5">{{$data['data']['share_valor']}}</h2>
                        </div>
                    </div>
            ...
            <div class="col-span-12 sm:col-span-12 lg:col-span-12 mt-8">
                ...
                @if(count($data['kpi4_data']) > 0)
                            @foreach($data['kpi4_data'] as $key => $value)
