...
@section('subhead')
<title>Investigación Global - Usuario - SIMEP</title>
@endsection
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 md:col-span-12 mt-8">
                <div class="intro-y items-center ">
                    <h2 class="text-xl font-bold truncate mr-5 w-full title-section">Investigación Global</h2>

                    <div class=" mt-8">
                    <div class="px-2">
                        <div class="h-full  rounded-md">
                          
                            <p>Sección que contiene los informes de investigación que son trasversales; es decir que involucra a diferentes países.</p>
                        </div>
                    </div>
            ...
            <div class="col-span-12 md:col-span-12">
                ...
                <div class="intro-y box p-5 col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <select id="year-filter" class="form-select form-select-lg sm:mt-2 sm:mr-2 col-span-12 sm:col-span-3 xl:col-span-3"
                            ...
                            <option @if($data['current_year'] == $value->year) selected @endif value="{{$value->year}}">{{$value->year}}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
...
if(ano != ""){
    ...
    jQuery.ajax({
                type: 'POST',
                url: "{{ url('usuario/filtro-investigacion-global') }}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    ano: ano
                },
...
//location.href = "https://sim-ep.com/usuario/global-investigacion?ano_filtro="+ano;
