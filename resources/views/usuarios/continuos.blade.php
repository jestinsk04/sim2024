...
@section('subhead')
<title>Continuos - Bebidas - Usuario - SIMEP</title>
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 md:col-span-12 mt-8">
                <div class="intro-y items-center ">
                    <h2 class="text-xl font-bold truncate mr-5 w-full title-section">Continuos - Bebidas</h2>

                    <div class=" mt-8">
                    <div class="px-2">
                        <div class="h-full  rounded-md">
                          
                            <p>Estudios de investigacion y analisis de caracter continuos para el segmento de Bebidas</p>
                        </div>
                    </div>
            ...
            <div class="col-span-12 md:col-span-12">
                ...
                <div class="col-span-12 lg:col-span-12">
                    ...
                    <div class="grid grid-cols-12 gap-2 mb-4">
                        ...
                        <select id="segmento-filter" class="form-select form-select-lg sm:mt-2 sm:mr-2 col-span-12 sm:col-span-3 xl:col-span-3"
                            aria-label=".form-select-lg example">
                            <option value="">Segmento</option>
                            @if(count($data['segmentos_list']) > 0)
                            @foreach($data['segmentos_list'] as $key => $value)

                            <option value="{{$value->segmento}}">{{$value->segmento}}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
                    ...
                    <table class="table table-report mt-4 col-span-6" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center whitespace-nowrap">Segmento</th>
                        ...
                        @if(count($data['data']) > 0)
                            ...
                            <tr class="intro-x">
                                ...
                                <td class="text-center">{{$value->segmento}}</td>
...
$(document).on("change", "#year-filter, #segmento-filter", function () {

jQuery.noConflict();
console.log("Cambio Año")
var ano = jQuery("#year-filter").val();
var segmento = jQuery("#segmento-filter").val();
    ...
    jQuery.ajax({
                type: 'POST',
                url: "{{ url('usuario/filtro-continuos') }}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    ano: ano,
                    segmento: segmento,
                ...
                success: function (data) {
                    ...
                    jQuery.each(response, function(i, item) {
                           ...
                           element += '<tr class="intro-x">'+
                                ...
                                '<td class="text-center">'+response[i].segmento+'</td>'+
