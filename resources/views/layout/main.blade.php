...
@section('body')
    <body class="p-5 side-menu-open" style="background-color: #025091 !important>
        ...
        <script src="https://sim-ep.com/build/assets/jquery.number.js"></script>
...
.side-menu-open .sm\:col-span-6 {
    grid-column: span 12 / span 12;
}
.side-menu-open .md\:grid-cols-5 {
    grid-template-columns: repeat(2,minmax(0,1fr));
}
.side-menu-open .md\:text-base {
    font-size: 1rem !important;
} 
.side-menu-open .md\:text-3xl {
    font-size: 1.5vw !important;
}
.side-menu-open .search {
    display:none;
}
}
...
window.scrollTo({ top: 0, behavior: 'smooth' });
    ...
    <div class="loader" style="visibility:hidden;width: 100vw; height: 100%; position: fixed; background-color: rgba(255,255,255,0.8); z-index: 9999; display: flex; align-items: center; text-align: center;top: 0px;">
